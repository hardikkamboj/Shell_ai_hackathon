...
if __name__ == "__main__":
    ...
    turb_coords   =  getTurbLoc(r'/home/hardik/shell.ai hackathon/resources/Shell_Hackathon Dataset/turbine_loc_test.csv')
    
    # Load the power curve
    power_curve   =  loadPowerCurve('//home/hardik/shell.ai hackathon/resources/Shell_Hackathon Dataset/power_curve.csv')
    
    # Pass wind data csv file location to function binWindResourceData.
    # Retrieve probabilities of wind instance occurence.
    wind_inst_freq =  binWindResourceData(r'/home/hardik/shell.ai hackathon/resources/Shell_Hackathon Dataset/full_wind_data.csv')   
